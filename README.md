...
- LoL [modules](https://github.com/NUStreaming/LoL-LowOnLatency/tree/master/dash.js/samples/low-latency/abr): LoLBitrateSelection.js (new), LoLQoEEvaluation.js (new), LoLTHMeasurement.js (new), PlaybackController.js (modified)
