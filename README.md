...
- Bentaleb, A.,  Akcay, M. N., Lim, M., Begen, A. C., & Zimmermann, R. (2020, Sept). Catching the Moment with LoL^+ in Twitch-LikeLow-Latency Live Streaming Platforms (to appear).
  - GitHub repository: [LoL^+](https://github.com/NUStreaming/LoL-plus)
...
- LoL [modules](https://github.com/NUStreaming/LoL/tree/master/dash.js/samples/low-latency/abr): LoL_learningRule.js (new), LoL_heuristicRule.js (new), LoL_qoeEvaluator.js (new), LoL_tputMeasurement.js (new), PlaybackController.js (modified)
